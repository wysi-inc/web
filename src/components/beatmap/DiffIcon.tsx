...
export const DiffIconLink = (p: { diff: number; mode: Mode; size: number; name: string; setId: number; diffId: number; color?: string }) => (
...
const DiffIcon = (p: { size: number; sr: number; mode: Mode; color?: string }) => (
