function LanguageButton(p: { lang: any }) {
    return (<>
        <button class="btn btn-sm btn-ghost flex flex-row flex-nowrap gap-2 justify-start px-1 items-center" onclick={`document.cookie = 'lang=${p.lang[2]}'; window.location.reload();`}>
