function LanguageButton(p: { lang: any }) {
    return (<>
        <button class="btn btn-ghost btn-sm flex flex-row flex-nowrap items-center justify-start gap-2 px-1" onclick={`document.cookie = 'lang=${p.lang[2]}'; window.location.reload();`}>
