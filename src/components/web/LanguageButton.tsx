function LanguageButton(p: { lang: any }) {
    return (<>
        <button class="btn btn-sm btn-ghost flex flex-row gap-2 justify-start px-1 items-center"
            ...
            <div class="tooltip flex items-center justify-center h-5 w-7" data-tip={p.lang[0].name}>
                <img src={p.lang[1]} alt={`${p.lang[0].name}'s flag`} loading="lazy" class="max-h-5 max-w-7 rounded-sm drop-shadow-solid" />
            </div>
