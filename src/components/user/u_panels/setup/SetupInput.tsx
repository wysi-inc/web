...
const SetupInput = ({ id, name, editable, icon, value, measure, type }: Props) => {
    ...
    return (
        <label class={`${!value && type === "text" && "group-disabled:hidden"} flex input has-[:disabled]:bg-base-300 has-[:disabled]:border-0 input-sm input-bordered text-sm items-center gap-2`}>
