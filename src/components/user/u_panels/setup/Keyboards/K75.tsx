    ...
    return <div class="p-1 outline outline-1 rounded-lg w-min">
        <div class="flex flex-col">
            <div class="flex flex-row justify-between mb-1">
                ...
                <div class="flex flex-row">
                    <Key char={'del'} code={'del'} keys={p.keys} width={1} />
                </div>
            </div>
            ...
            <div class="flex flex-row items-start">
                ...
                <Key char={'end'} code={'end'} keys={p.keys} width={1} />
            </div>
            <div class="flex flex-row items-start">
                ...
                <Key char={'pu'} code={'pup'} keys={p.keys} width={1} />
            </div>
            <div class="flex flex-row items-start">
                ...
                <Key char={'⇧'} code={'shift'} keys={p.keys} width={1.75} />
