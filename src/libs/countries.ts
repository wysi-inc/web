...
LANGUAGES.set("ab", { name: "Abkhaz", nativeName: "аҧсуа" });
LANGUAGES.set("aa", { name: "Afar", nativeName: "Afaraf" });
LANGUAGES.set("af", { name: "Afrikaans", nativeName: "Afrikaans" });
LANGUAGES.set("ak", { name: "Akan", nativeName: "Akan" });
LANGUAGES.set("sq", { name: "Albanian", nativeName: "Shqip" });
LANGUAGES.set("am", { name: "Amharic", nativeName: "አማርኛ" });
LANGUAGES.set("ar", { name: "Arabic", nativeName: "العربية" });
LANGUAGES.set("an", { name: "Aragonese", nativeName: "Aragonés" });
LANGUAGES.set("hy", { name: "Armenian", nativeName: "Հայերեն" });
LANGUAGES.set("as", { name: "Assamese", nativeName: "অসমীয়া" });
LANGUAGES.set("av", { name: "Avaric", nativeName: "авар мацӀ, магӀарул мацӀ" });
LANGUAGES.set("ae", { name: "Avestan", nativeName: "avesta" });
LANGUAGES.set("ay", { name: "Aymara", nativeName: "aymar aru" });
LANGUAGES.set("az", { name: "Azerbaijani", nativeName: "azərbaycan dili" });
LANGUAGES.set("bm", { name: "Bambara", nativeName: "bamanankan" });
LANGUAGES.set("ba", { name: "Bashkir", nativeName: "башҡорт теле" });
LANGUAGES.set("eu", { name: "Basque", nativeName: "euskara, euskera" });
LANGUAGES.set("be", { name: "Belarusian", nativeName: "Беларуская" });
LANGUAGES.set("bn", { name: "Bengali", nativeName: "বাংলা" });
LANGUAGES.set("bh", { name: "Bihari", nativeName: "भोजपुरी" });
LANGUAGES.set("bi", { name: "Bislama", nativeName: "Bislama" });
LANGUAGES.set("bs", { name: "Bosnian", nativeName: "bosanski jezik" });
LANGUAGES.set("br", { name: "Breton", nativeName: "brezhoneg" });
LANGUAGES.set("bg", { name: "Bulgarian", nativeName: "български език" });
LANGUAGES.set("my", { name: "Burmese", nativeName: "ဗမာစာ" });
LANGUAGES.set("ca", { name: "Catalan; Valencian", nativeName: "Català" });
LANGUAGES.set("ch", { name: "Chamorro", nativeName: "Chamoru" });
LANGUAGES.set("ce", { name: "Chechen", nativeName: "нохчийн мотт" });
LANGUAGES.set("ny", { name: "Chichewa; Chewa; Nyanja", nativeName: "chiCheŵa, chinyanja" });
LANGUAGES.set("zh", { name: "Chinese (Simplified)", nativeName: "简体中文" });
LANGUAGES.set("zh-hant", { name: "Chinese (Traditional)", nativeName: "繁體中文" });
LANGUAGES.set("cv", { name: "Chuvash", nativeName: "чӑваш чӗлхи" });
LANGUAGES.set("kw", { name: "Cornish", nativeName: "Kernewek" });
LANGUAGES.set("co", { name: "Corsican", nativeName: "corsu, lingua corsa" });
LANGUAGES.set("cr", { name: "Cree", nativeName: "ᓀᐦᐃᔭᐍᐏᐣ" });
LANGUAGES.set("hr", { name: "Croatian", nativeName: "hrvatski" });
LANGUAGES.set("cs", { name: "Czech", nativeName: "česky, čeština" });
LANGUAGES.set("da", { name: "Danish", nativeName: "dansk" });
LANGUAGES.set("dv", { name: "Divehi; Dhivehi; Maldivian;", nativeName: "ދިވެހި" });
LANGUAGES.set("nl", { name: "Dutch", nativeName: "Nederlands" });
LANGUAGES.set("en", { name: "English", nativeName: "English" });
LANGUAGES.set("eo", { name: "Esperanto", nativeName: "Esperanto" });
LANGUAGES.set("et", { name: "Estonian", nativeName: "Eesti keel" });
LANGUAGES.set("ee", { name: "Ewe", nativeName: "Eʋegbe" });
LANGUAGES.set("fo", { name: "Faroese", nativeName: "føroyskt" });
LANGUAGES.set("fj", { name: "Fijian", nativeName: "vosa Vakaviti" });
LANGUAGES.set("fi", { name: "Finnish", nativeName: "Suomi" });
LANGUAGES.set("fr", { name: "French", nativeName: "Français" });
LANGUAGES.set("ff", { name: "Fula; Fulah; Pulaar; Pular", nativeName: "Fulfulde, Pulaar, Pular" });
LANGUAGES.set("gl", { name: "Galician", nativeName: "Galego" });
LANGUAGES.set("ka", { name: "Georgian", nativeName: "ქართული" });
LANGUAGES.set("de", { name: "German", nativeName: "Deutsch" });
LANGUAGES.set("el", { name: "Greek, Modern", nativeName: "Ελληνικά" });
LANGUAGES.set("gn", { name: "Guaraní", nativeName: "Avañeẽ" });
LANGUAGES.set("gu", { name: "Gujarati", nativeName: "ગુજરાતી" });
LANGUAGES.set("ht", { name: "Haitian; Haitian Creole", nativeName: "Kreyòl ayisyen" });
LANGUAGES.set("ha", { name: "Hausa", nativeName: "Hausa, هَوُسَ" });
LANGUAGES.set("he", { name: "Hebrew (modern)", nativeName: "עברית" });
LANGUAGES.set("hz", { name: "Herero", nativeName: "Otjiherero" });
LANGUAGES.set("hi", { name: "Hindi", nativeName: "हिन्दी, हिंदी" });
LANGUAGES.set("ho", { name: "Hiri Motu", nativeName: "Hiri Motu" });
LANGUAGES.set("hu", { name: "Hungarian", nativeName: "Magyar" });
LANGUAGES.set("ia", { name: "Interlingua", nativeName: "Interlingua" });
LANGUAGES.set("id", { name: "Indonesian", nativeName: "Bahasa Indonesia" });
LANGUAGES.set("ie", { name: "Interlingue", nativeName: "Originally called Occidental; then Interlingue after WWII" });
LANGUAGES.set("ga", { name: "Irish", nativeName: "Gaeilge" });
LANGUAGES.set("ig", { name: "Igbo", nativeName: "Asụsụ Igbo" });
LANGUAGES.set("ik", { name: "Inupiaq", nativeName: "Iñupiaq, Iñupiatun" });
LANGUAGES.set("io", { name: "Ido", nativeName: "Ido" });
LANGUAGES.set("is", { name: "Icelandic", nativeName: "Íslenska" });
LANGUAGES.set("it", { name: "Italian", nativeName: "Italiano" });
LANGUAGES.set("iu", { name: "Inuktitut", nativeName: "ᐃᓄᒃᑎᑐᑦ" });
LANGUAGES.set("ja", { name: "Japanese", nativeName: "日本語" });
LANGUAGES.set("jv", { name: "Javanese", nativeName: "basa Jawa" });
LANGUAGES.set("kl", { name: "Kalaallisut, Greenlandic", nativeName: "kalaallisut, kalaallit oqaasii" });
LANGUAGES.set("kn", { name: "Kannada", nativeName: "ಕನ್ನಡ" });
LANGUAGES.set("kr", { name: "Kanuri", nativeName: "Kanuri" });
LANGUAGES.set("ks", { name: "Kashmiri", nativeName: "कश्मीरी, كشميري‎" });
LANGUAGES.set("kk", { name: "Kazakh", nativeName: "Қазақ тілі" });
LANGUAGES.set("km", { name: "Khmer", nativeName: "ភាសាខ្មែរ" });
LANGUAGES.set("ki", { name: "Kikuyu, Gikuyu", nativeName: "Gĩkũyũ" });
LANGUAGES.set("rw", { name: "Kinyarwanda", nativeName: "Ikinyarwanda" });
LANGUAGES.set("ky", { name: "Kirghiz, Kyrgyz", nativeName: "кыргыз тили" });
LANGUAGES.set("kv", { name: "Komi", nativeName: "коми кыв" });
LANGUAGES.set("kg", { name: "Kongo", nativeName: "KiKongo" });
LANGUAGES.set("ko", { name: "Korean", nativeName: "한국어 (韓國語), 조선말 (朝鮮語)" });
LANGUAGES.set("ku", { name: "Kurdish", nativeName: "Kurdî, كوردی‎" });
LANGUAGES.set("kj", { name: "Kwanyama, Kuanyama", nativeName: "Kuanyama" });
LANGUAGES.set("la", { name: "Latin", nativeName: "latine, lingua latina" });
LANGUAGES.set("lb", { name: "Luxembourgish, Letzeburgesch", nativeName: "Lëtzebuergesch" });
LANGUAGES.set("lg", { name: "Luganda", nativeName: "Luganda" });
LANGUAGES.set("li", { name: "Limburgish, Limburgan, Limburger", nativeName: "Limburgs" });
LANGUAGES.set("ln", { name: "Lingala", nativeName: "Lingála" });
LANGUAGES.set("lo", { name: "Lao", nativeName: "ພາສາລາວ" });
LANGUAGES.set("lt", { name: "Lithuanian", nativeName: "lietuvių kalba" });
LANGUAGES.set("lu", { name: "Luba-Katanga", nativeName: "" });
LANGUAGES.set("lv", { name: "Latvian", nativeName: "Latviešu" });
...
LANGUAGES.set("mr", { name: "Marathi (Marāṭhī)", nativeName: "मराठी" });
LANGUAGES.set("mh", { name: "Marshallese", nativeName: "Kajin M̧ajeļ" });
LANGUAGES.set("mn", { name: "Mongolian", nativeName: "монгол" });
LANGUAGES.set("na", { name: "Nauru", nativeName: "Ekakairũ Naoero" });
LANGUAGES.set("nv", { name: "Navajo, Navaho", nativeName: "Diné bizaad, Dinékʼehǰí" });
LANGUAGES.set("nb", { name: "Norwegian Bokmål", nativeName: "Norsk bokmål" });
LANGUAGES.set("nd", { name: "North Ndebele", nativeName: "isiNdebele" });
LANGUAGES.set("ne", { name: "Nepali", nativeName: "नेपाली" });
LANGUAGES.set("ng", { name: "Ndonga", nativeName: "Owambo" });
LANGUAGES.set("nn", { name: "Norwegian Nynorsk", nativeName: "Norsk nynorsk" });
LANGUAGES.set("no", { name: "Norwegian", nativeName: "Norsk" });
LANGUAGES.set("ii", { name: "Nuosu", nativeName: "ꆈꌠ꒿ Nuosuhxop" });
LANGUAGES.set("nr", { name: "South Ndebele", nativeName: "isiNdebele" });
LANGUAGES.set("oc", { name: "Occitan", nativeName: "Occitan" });
LANGUAGES.set("oj", { name: "Ojibwe, Ojibwa", nativeName: "ᐊᓂᔑᓈᐯᒧᐎᓐ" });
LANGUAGES.set("cu", { name: "Old Church Slavonic, Church Slavic, Church Slavonic, Old Bulgarian, Old Slavonic", nativeName: "ѩзыкъ словѣньскъ" });
LANGUAGES.set("om", { name: "Oromo", nativeName: "Afaan Oromoo" });
LANGUAGES.set("or", { name: "Oriya", nativeName: "ଓଡ଼ିଆ" });
LANGUAGES.set("os", { name: "Ossetian, Ossetic", nativeName: "ирон æвзаг" });
LANGUAGES.set("pa", { name: "Panjabi, Punjabi", nativeName: "ਪੰਜਾਬੀ, پنجابی‎" });
LANGUAGES.set("pi", { name: "Pāli", nativeName: "पाऴि" });
LANGUAGES.set("fa", { name: "Persian", nativeName: "فارسی" });
LANGUAGES.set("pl", { name: "Polish", nativeName: "Polski" });
LANGUAGES.set("ps", { name: "Pashto, Pushto", nativeName: "پښتو" });
LANGUAGES.set("pt", { name: "Portuguese", nativeName: "Português" });
LANGUAGES.set("pt-br", { name: "Brazilian Portuguese", nativeName: "Português(BR)" });
LANGUAGES.set("qu", { name: "Quechua", nativeName: "Runa Simi, Kichwa" });
LANGUAGES.set("rm", { name: "Romansh", nativeName: "rumantsch grischun" });
LANGUAGES.set("rn", { name: "Kirundi", nativeName: "kiRundi" });
LANGUAGES.set("ro", { name: "Romanian, Moldavian, Moldovan", nativeName: "română" });
LANGUAGES.set("ru", { name: "Russian", nativeName: "Русский" });
LANGUAGES.set("sa", { name: "Sanskrit (Saṁskṛta)", nativeName: "संस्कृतम्" });
LANGUAGES.set("sc", { name: "Sardinian", nativeName: "sardu" });
LANGUAGES.set("sd", { name: "Sindhi", nativeName: "सिन्धी, سنڌي، سندھی‎" });
LANGUAGES.set("se", { name: "Northern Sami", nativeName: "Davvisámegiella" });
LANGUAGES.set("sm", { name: "Samoan", nativeName: "gagana faa Samoa" });
LANGUAGES.set("sg", { name: "Sango", nativeName: "yângâ tî sängö" });
LANGUAGES.set("sr", { name: "Serbian", nativeName: "Српски" });
LANGUAGES.set("gd", { name: "Scottish Gaelic; Gaelic", nativeName: "Gàidhlig" });
LANGUAGES.set("sn", { name: "Shona", nativeName: "chiShona" });
LANGUAGES.set("si", { name: "Sinhala, Sinhalese", nativeName: "සිංහල" });
LANGUAGES.set("sk", { name: "Slovak", nativeName: "slovenčina" });
LANGUAGES.set("sl", { name: "Slovene", nativeName: "slovenščina" });
LANGUAGES.set("so", { name: "Somali", nativeName: "Soomaaliga, af Soomaali" });
LANGUAGES.set("st", { name: "Southern Sotho", nativeName: "Sesotho" });
LANGUAGES.set("es", { name: "Spanish", nativeName: "Español" });
LANGUAGES.set("su", { name: "Sundanese", nativeName: "Basa Sunda" });
LANGUAGES.set("sw", { name: "Swahili", nativeName: "Kiswahili" });
LANGUAGES.set("ss", { name: "Swati", nativeName: "SiSwati" });
LANGUAGES.set("sv", { name: "Swedish", nativeName: "svenska" });
LANGUAGES.set("ta", { name: "Tamil", nativeName: "தமிழ்" });
LANGUAGES.set("te", { name: "Telugu", nativeName: "తెలుగు" });
LANGUAGES.set("tg", { name: "Tajik", nativeName: "тоҷикӣ, toğikī, تاجیکی‎" });
LANGUAGES.set("th", { name: "Thai", nativeName: "ไทย" });
LANGUAGES.set("ti", { name: "Tigrinya", nativeName: "ትግርኛ" });
LANGUAGES.set("bo", { name: "Tibetan Standard, Tibetan, Central", nativeName: "བོད་ཡིག" });
LANGUAGES.set("tk", { name: "Turkmen", nativeName: "Türkmen, Түркмен" });
LANGUAGES.set("tl", { name: "Tagalog", nativeName: "Wikang Tagalog, ᜏᜒᜃᜅ᜔ ᜆᜄᜎᜓᜄ᜔" });
LANGUAGES.set("tn", { name: "Tswana", nativeName: "Setswana" });
LANGUAGES.set("to", { name: "Tonga (Tonga Islands)", nativeName: "faka Tonga" });
LANGUAGES.set("tr", { name: "Turkish", nativeName: "Türkçe" });
LANGUAGES.set("ts", { name: "Tsonga", nativeName: "Xitsonga" });
LANGUAGES.set("tt", { name: "Tatar", nativeName: "татарча, tatarça, تاتارچا‎" });
LANGUAGES.set("tw", { name: "Twi", nativeName: "Twi" });
LANGUAGES.set("ty", { name: "Tahitian", nativeName: "Reo Tahiti" });
LANGUAGES.set("ug", { name: "Uighur, Uyghur", nativeName: "Uyƣurqə, ئۇيغۇرچە‎" });
LANGUAGES.set("uk", { name: "Ukrainian", nativeName: "українська" });
LANGUAGES.set("ur", { name: "Urdu", nativeName: "اردو" });
LANGUAGES.set("uz", { name: "Uzbek", nativeName: "zbek, Ўзбек, أۇزبېك‎" });
LANGUAGES.set("ve", { name: "Venda", nativeName: "Tshivenḓa" });
LANGUAGES.set("vi", { name: "Vietnamese", nativeName: "Tiếng Việt" });
LANGUAGES.set("vo", { name: "Volapük", nativeName: "Volapük" });
LANGUAGES.set("wa", { name: "Walloon", nativeName: "Walon" });
LANGUAGES.set("cy", { name: "Welsh", nativeName: "Cymraeg" });
LANGUAGES.set("wo", { name: "Wolof", nativeName: "Wollof" });
LANGUAGES.set("fy", { name: "Western Frisian", nativeName: "Frysk" });
LANGUAGES.set("xh", { name: "Xhosa", nativeName: "isiXhosa" });
LANGUAGES.set("yi", { name: "Yiddish", nativeName: "ייִדיש" });
LANGUAGES.set("yo", { name: "Yoruba", nativeName: "Yorùbá" });
LANGUAGES.set("za", { name: "Zhuang, Chuang", nativeName: "Saɯ cueŋƅ, Saw cuengh" });
LANGUAGES.set("min", { name: "Minecraft", nativeName: "ᒲ╎リᒷᓵ∷ᔑ⎓ℸ ̣" });
