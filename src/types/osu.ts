...
export const modeUnion = t.Union([t.Literal("osu"), t.Literal("taiko"), t.Literal("fruits"), t.Literal("mania")]);

export const scoresUnion = t.Union([t.Literal("global"), t.Literal("country"), t.Literal("friend")]);
...
export type PanelType = {
    ...
    show_if: boolean;
    manual?: boolean;
} & ({ jsx: JSX.Element; url?: never } | { url: string; body?: string; jsx?: never });
