...
INSERT INTO modes (mode_id, mode_name) VALUES (1, 'osu');
INSERT INTO modes (mode_id, mode_name) VALUES (2, 'taiko');
INSERT INTO modes (mode_id, mode_name) VALUES (3, 'fruits');
INSERT INTO modes (mode_id, mode_name) VALUES (4, 'mania');
...
CREATE TABLE user_country_rank_highest (
    user_id int PRIMARY KEY,
    rank int,
    updated_at date,
...
CREATE TABLE user_global_rank_highest (
    user_id int PRIMARY KEY,
    rank int,
    updated_at date,
    FOREIGN KEY (user_id) REFERENCES users(user_id)
...
CREATE TABLE wysi_badges (
    badge_id int PRIMARY KEY,
    title varchar(20)
)

INSERT INTO wysi_badges (badge_id, title) VALUES (1, 'developer');
INSERT INTO wysi_badges (badge_id, title) VALUES (2, 'translator');
INSERT INTO wysi_badges (badge_id, title) VALUES (3, 'moderator');

CREATE TABLE user_wysi_badges (
    user_id int,
    badge_id int,
...
CREATE TABLE user_active_tournament_banners (
    user_id int,
    banner_id int,
    tournament_id int,
    image varchar(255),
...
CREATE TABLE user_country_rank (
    user_id int,
    rank_date date,
    rank int,
...
CREATE TABLE user_monthly_plays (
    user_id int,
    play_count int,
    month_date date,
...
CREATE TABLE user_monthly_replays (
    user_id int,
    replay_count int,
    replay_date date,
...
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('k2', '2 Keys');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('k3', '3 Keys');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('k4', '4 Keys');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('k40', '40%');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('k60', '60%');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('k75', '75%');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('ktkl', 'TKL');
INSERT INTO keyboard_layouts (layout_code, layout_name) VALUES ('kfull', 'FULL');
...
DROP TABLE user_mouse;
CREATE TABLE user_mouse (
	user_id int PRIMARY KEY,
	model varchar(255),
    dpi int,
    FOREIGN KEY (user_id) REFERENCES users(user_id)
...
CREATE TABLE user_keyboard_keys (
	user_id int,
	key_code varchar(5),
	FOREIGN KEY (user_id) REFERENCES users(user_id),
