...
(function(root, factory) {
    ...
    return (function() {
        ...
        function saveCurrentPageToHistory() {
            ...
            if (htmx.config.historyEnabled) originalHistory.replaceState({ htmx: true }, getDocument().title, window.location.href);
        }
        ...
        function pushUrlIntoHistory(path) {
            ...
            if (htmx.config.historyEnabled) {
                originalHistory.pushState({ htmx: true }, "", path);
            }
            currentPathForHistory = path;
        }

        function replaceUrlInHistory(path) {
            if (htmx.config.historyEnabled) originalHistory.replaceState({ htmx: true }, "", path);
            currentPathForHistory = path;
        }
